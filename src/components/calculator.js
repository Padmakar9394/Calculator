  ...
  <>
    <section>
        <div className="bg-gray-900 w-96 h-screen mx-auto rounded-lg overflow-hidden mt-10">
            <div className='text-gray-200 w-full font-bold text-3xl h-16 flex items-center space-x-2'>
                <GiHamburgerMenu />
                <p>CALCULATOR APP</p>
            </div>
            ...
            <div className='w-full h-20'>
                <input type='text'
                 placeholder='0'
                 value={number}
                 className='w-full h-full border border-white text-white bg-gray-900 text-4xl text-right pr-3'
                  />
            </div>
            ...
            <div className='grid grid-cols-4 gap-2 mt-10 mx-3'>
                ...
                <button value='+' onClick={handleClick} className='text-gray w-20 h-40 bg-white rounded-lg font-bold text-3xl flex justify-center items-center shadow row-span-2'>+</button>
